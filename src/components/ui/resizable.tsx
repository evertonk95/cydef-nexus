...
/**
 * Wrapper shadcn/ui do react-resizable-panels na API v4.
 * Na v4 os primitivos são Group, Panel e Separator (antes PanelGroup e
 * PanelResizeHandle) e a orientação é exposta em `aria-orientation`.
 */
