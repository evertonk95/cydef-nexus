          ...
          <div className="col-span-1 lg:col-span-6 md:pr-10 flex flex-col lg:pt-20 h-full pt-10 pr-6 items-end justify-center">
            ...
            <div className="relative mb-12 mr-4 w-64 md:w-72 aspect-video group perspective-1000 animate-on-scroll">
              ...
              <div className="relative w-full h-full transform-style-3d">
                <div className={`card-stack-item absolute inset-0 rounded-lg overflow-hidden border border-white/10 shadow-2xl origin-bottom bg-neutral-900 ${activeStep === 3 ? 'translate-y-0 scale-100 z-30 opacity-100' : 'translate-y-6 scale-90 z-10 opacity-40'}`}>
                ...
                <div className={`card-stack-item absolute inset-0 rounded-lg overflow-hidden border border-white/10 shadow-2xl origin-bottom bg-neutral-900 ${activeStep === 2 ? 'translate-y-0 scale-100 z-30 opacity-100' : 'translate-y-3 scale-95 z-20 opacity-60'}`}>
                ...
                <div className={`card-stack-item absolute inset-0 rounded-lg overflow-hidden border border-white/10 shadow-2xl origin-bottom bg-neutral-900 ${activeStep === 1 ? 'translate-y-0 scale-100 z-30 opacity-100' : 'translate-y-0 scale-100 z-30 opacity-100'}`}>
