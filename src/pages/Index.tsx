  ...
  return (
    <div className="text-white font-sans antialiased overflow-x-hidden selection:bg-orange-500/30 flex flex-col min-h-screen relative">
      ...
      <div className="flex-1 flex flex-col w-full max-w-7xl mr-auto ml-auto relative z-10 pt-20">
        ...
        {/* hero — honesto: ecossistema em construção, sem simular serviços (diretriz Everton 03/09) */}
        <div className="flex-1 flex flex-col items-center justify-center pt-32 pb-16 px-6 text-center">
          <div className="inline-flex items-center gap-2 text-orange-500 mb-8 animate-on-scroll">
            ...
            <span className="text-xs font-bold tracking-widest uppercase text-orange-500/80">Ecossistema em construção</span>
          </div>
          ...
          <p className="leading-relaxed text-lg md:text-xl font-medium text-white/60 max-w-2xl animate-on-scroll mb-12">
            Estamos construindo a CyDef: um ecossistema de cibersegurança que
            protege pessoas, compartilha conhecimento e resolve problemas
            complexos — com o pé no chão. Hoje isso significa conteúdo técnico
            verificável e formação gratuita de verdade. Serviços e promessas
            virão depois, somente quando existirem de fato.
          </p>
          <div className="flex flex-wrap justify-center gap-6 items-center animate-on-scroll">
            <Link className="group isolate inline-flex cursor-pointer overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_50px_10px_rgba(249,115,22,0.45)] bg-gradient-to-b from-white/20 via-white/0 to-white/5 rounded-full relative shadow-[0_0_25px_rgba(249,115,22,0.3),0_8px_40px_rgba(249,115,22,0.15)]" to="/contato">
              ...
              <div className="z-10 flex gap-3 sm:w-auto overflow-hidden text-sm font-medium text-white w-full rounded-full pt-3 pr-5 pb-3 pl-4 relative items-center">
                ...
                <span className="whitespace-nowrap relative z-10 font-medium tracking-tight text-base text-white/95 group-hover:text-white transition-colors">Falar com a CyDef</span>
            ...
            <Link to="/academy" className="inline-flex items-center gap-2 px-6 py-4 rounded-full border border-orange-500/40 text-orange-400 hover:bg-orange-500/10 hover:border-orange-500 transition-colors font-medium text-sm">
              Pré-inscrição gratuita na Academy
        ...
        {/* stats — apenas números reais (diretriz Everton 03/09):
            artigos publicados e alunos matriculados. */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-12 gap-x-8 mt-20 pt-12 border-t border-white/5 pb-24 relative z-20">
          <div className="flex flex-col gap-2 items-center md:items-start animate-on-scroll">
            <div className="md:text-7xl lg:text-8xl leading-none text-6xl font-light text-white tracking-tighter">{blogPosts.length}</div>
            <div className="text-xl font-medium pl-1 text-neutral-400">Artigos técnicos publicados</div>
          </div>
          <div className="flex flex-col gap-2 items-center md:items-start animate-on-scroll">
            ...
            <div className="text-xl font-medium pl-1 text-neutral-400">Alunos matriculados na Academy</div>
          </div>
        </div>
