 ...
 *
 * ATENÇÃO (gate de go-live): o texto de v2026.1 é RASCUNHO — o texto final
 * revisado por jurídico/DPO deve substituí-lo antes do go-live (SEC-003), com
 * nova entrada de versão se o conteúdo mudar (imutabilidade preservada).
 */
